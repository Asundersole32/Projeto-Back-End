...
from machines.viewsets.machine_data_views.machine_seeded_data_get_view import GetSeededMachineDataView
...
urlpatterns = [
    ...
    path('seeded_data/<int:machine_id>/', GetSeededMachineDataView.as_view(), name='seeded_machine_data_get_view'),
]